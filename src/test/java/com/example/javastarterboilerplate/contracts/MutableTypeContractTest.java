...
class MutableTypeContractTest {
  ...
  void exposesMutableContracts() {
    ...
    assertThat(documentationProperties.getSpecResourcePath())
        .isEqualTo("META-INF/swagger/openapi.yaml");
    assertThat(documentationProperties.getOpenApiVersion()).isEqualTo("3.1.1");
    assertThat(documentationProperties.getScalarScriptUrl())
        .isEqualTo("https://cdn.example.test/scalar.js");
    ...
    assertThat(persistenceProperties.isEnabled()).isTrue();
