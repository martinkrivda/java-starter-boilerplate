...
class ApiResponseFactoryTest {
    ...
    void createsErrorResponsesAndSupportsTrailingSlashProblemBaseUri() {
        ...
        var response = factory.error(request, HttpStatus.BAD_REQUEST, "bad-request", "Bad request", "bad input",
                "E1001", List.of());
        ...
        assertThat(response.body().error().type()).isEqualTo("https://api.example.com/problems/bad-request");
