...
class HealthControllerTest {
  ...
  void reportsReadyBeforeShutdownStarts() {
    HealthController controller =
        new HealthController(applicationInfoService(), new ApplicationShutdownState(), clock);
    ...
    Mockito.when(service.getInfo())
        .thenReturn(
            new ApplicationInfoResponse(
                ...
                List.of("test"),
                List.of(
                    new ApplicationComponentStatusResponse("storage", false, "disabled"),
                    new ApplicationComponentStatusResponse("pdfbox", true, "ready"),
                    new ApplicationComponentStatusResponse("dss", true, "ready"))));
    HealthController controller =
        new HealthController(service, new ApplicationShutdownState(), clock);
  ...
  void reportsNotReadyAndAcceptedDrainDuringShutdown() {
    ...
    HealthController controller =
        new HealthController(applicationInfoService(), shutdownState, clock);
