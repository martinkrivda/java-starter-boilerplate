...
class ApplicationInfoServiceTest {
    ...
    void reportsEnabledStorageWhenAdapterIsPresent() {
        ...
        ObjectStorage objectStorage = new ObjectStorage() {
            ...
            public StoredObject upload(StoredObjectUpload upload) {
                return new StoredObject(upload.key(), upload.contentType(), upload.content(), upload.metadata());
            }
        ...
        PdfDocumentService pdfDocumentService = new PdfDocumentService() {
            @Override
        ...
        DigitalSignatureService digitalSignatureService = new DigitalSignatureService() {
            ...
            public DigitalSignaturePreparationResult prepare(byte[] documentBytes, String fileName) {
                return new DigitalSignaturePreparationResult("dss", fileName, documentBytes.length, "application/pdf");
            }
        };
        ...
        ApplicationInfoService service = new ApplicationInfoService(infoProperties, persistenceProperties,
                s3StorageProperties, pdfBoxProperties, dssProperties, Optional.of(objectStorage), pdfDocumentService,
                digitalSignatureService, environment);
        ...
        assertThat(info.integrations()).anySatisfy(component -> {
    ...
    void reportsDisabledStorageWhenAdapterIsMissing() {
        ...
        ApplicationInfoService service = new ApplicationInfoService(infoProperties, persistenceProperties,
                s3StorageProperties, pdfBoxProperties, dssProperties, Optional.empty(), pdfDocumentService,
                digitalSignatureService, environment);
